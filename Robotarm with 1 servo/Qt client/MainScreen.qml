...
Pane {
    // Add this near the top of your MainScreen.ui.qml
    RowLayout {
        id: connectionLayout
        ...
        TextField {
            id: ipAddressField
            text: "192.168.5.75" // Your default IP
            placeholderText: "ESP32 IP Address"
        }
        ...
        Button {
            ...
            text: "Connect"
            onClicked: {
                // This will call the C++ function you create in the next step
                backend.connectToDevice(ipAddressField.text, parseInt(portField.text))
            }
        }
    }
    id: root
